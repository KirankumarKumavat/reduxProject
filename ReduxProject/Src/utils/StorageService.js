 ...
 */
    ...
    */
   function clear() {
      const keys = [STORAGE_KEYS.AUTH_TOKEN,  STORAGE_KEYS.USER_DETAILS,'nursinglefttime','nursingrighttime','pumpingtime','pumpingcurrent','nursingcurrent','clickArticle','clickMeditation','clickArticleMiId','child_id','charthome'];
   ...
   function clearTimenur() {
      const keys = ['nursinglefttime','nursingrighttime','nursingcurrent','clickArticle','clickMeditation','clickArticleMiId'];
      return AsyncStorage.multiRemove(keys);
   }
   ...
   function clearTimenurboth() {
      const keys = ['nursingrighttime','nursingcurrent','nursinglefttime',];
      return AsyncStorage.multiRemove(keys);
   }
   ...
   function clearTime() {
      const keys = ['pumpingtime','pumpingcurrent','clickArticle','clickMeditation','clickArticleMiId'];
      return AsyncStorage.multiRemove(keys);
   }
   /**
    * 
