...
export default function PushNotifications({ route, navigation }) {
   ...
   //       invokeApp: true,
   //       onOpen: () => { NavigationService.navigate('NotificationListScreen')},
   //    });
   // };
   /**
    * 
   ...
   const handleNotificationRedirection = (notification) => {
      if (notification.data.type === '1') {
         NavigationService.navigate('NotificationListScreen')
      }
      else if (notification.data.type === '2') {
         NavigationService.navigate('ArticlesDetailesScreen', { id: notification.data.article_id })
      }
